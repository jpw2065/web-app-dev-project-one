    ...
    render() {
        ...
        return (
            <div class="card text-left mb-4 mt-4">
                <div class="card-header font-weight-bold" style={ employedColor }>
                    <h4 class="mb-2 mt-2">{this.Capitalize(this.props.user.trade)} Worker</h4>
                </div>
                <div class="card-body">
                    <h5 class="font-weight-normal">{this.props.user.name}</h5>
                    ...
                    <div class="d-flex flex-row justify-content-end">
                        <a href={'/users/' + this.props.user.id} class="btn btn-primary mr-3">Profile</a>
                        <a href={'/users/' + this.props.user.id + '/edit'} class="btn btn-primary mr-3">Edit</a>
                    </div>
                </div>
